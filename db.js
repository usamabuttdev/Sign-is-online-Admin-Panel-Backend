...
async function loadConfig() {
  ...
  cachedConfig = {
    server: process.env.DB_HOST || process.env.DEV_DB_HOST || DEFAULTS.server,
    port: parseInt(process.env.DB_PORT || process.env.DEV_DB_PORT || DEFAULTS.port),
    user: process.env.DB_USER || process.env.DEV_DB_USER || DEFAULTS.user,
    password: process.env.DB_PASSWORD || process.env.DEV_DB_PASS || DEFAULTS.password,
    database: process.env.DB_NAME || process.env.DEV_DB_NAME || DEFAULTS.database,
  };
  return cachedConfig;
}
